...
export default function DebtsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-rose-950 text-slate-100 pb-24">
      {/* Header */}
      <div className="bg-gradient-to-br from-slate-950 via-rose-950 to-red-950 text-white px-4 sm:px-6 lg:px-12 pt-10 pb-12 rounded-b-[3rem] shadow-2xl border-b border-slate-800/60">
            ...
            <div className="space-y-3">
              {unpaidDebts.map(debt => {
                ...
                return (
                  <div 
                    key={debt.id} 
                  className={`bg-slate-900/70 rounded-2xl shadow-md p-4 sm:p-6 lg:p-7 border border-slate-800/80 hover:shadow-lg transition-all ${
          ...
          <div>
            ...
            <div className="space-y-3">
              {paidDebts.map(debt => (
                <div 
                  key={debt.id} 
                  className="bg-emerald-500/10 rounded-2xl shadow-md p-4 sm:p-5 lg:p-6 border border-emerald-500/20"
                >
